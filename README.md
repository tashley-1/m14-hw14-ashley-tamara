...
Navbar Component: Added a Bootstrap navbar with collapsible functionality for mobile responsiveness.
Content Section: Used the Bootstrap grid system to organize the content into three responsive columns for "About Me," "Hobbies," and "Career Goals."

### Additional Bootstrap Components:
Card Component: Added an example card with a title, text, and button.
Button Component: Added a standalone button as an example of another Bootstrap component.
